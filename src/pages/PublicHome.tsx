    ...
    >
      ...
      <section className="relative py-16 sm:py-24 text-center">
        ...
        <div className="relative max-w-3xl mx-auto px-4">
          ...
          <img src={partnerLogos} alt="Partner logos" className="mt-10 max-w-2xl w-full mx-auto opacity-90" />
        </div>
      </section>
      ...
      <footer className="py-8 text-center bg-card border-t border-border">
        <img src={partnerLogos} alt="Partner logos" className="max-w-lg w-full mx-auto mb-4 opacity-80" />
