      ...
      <header className="border-b border-accent bg-accent backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-accent-foreground/70">Compulsory Task – Face</p>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-xs font-semibold text-accent-foreground bg-accent-foreground/20 px-2 py-1 rounded">1. Face</span>
